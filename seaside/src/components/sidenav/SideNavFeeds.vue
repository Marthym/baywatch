  ...
  <ul class="mt-2 text-gray-600">
    ...
    <li class="mt-8">
      <a href="#home" class="flex ">
        <svg
            class="fill-current h-5 w-5 text-gray-300"
            viewBox="0 0 24 24">
          <path
        ...
        <span
            class="ml-2 capitalize font-medium text-gray-300">
						dashboard
					</span>
      </a>
    </li>
    ...
    <li class="mt-8">
      <a href="#home" class="flex">
        ...
        <span class="ml-2 capitalize font-medium text-gray-300">
					calendar
        </span>
      </a>
    </li>

    <li class="mt-8 shadow py-2 bg-gray-200 rounded-lg -ml-4">
    ...
    <li class="mt-8">
      <a href="#home" class="flex">
        <svg class="fill-current h-5 w-5 text-gray-300" viewBox="0 0 24 24">
          <path
